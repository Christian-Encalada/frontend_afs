...
import { buttonVariants } from '@/[lng]/components/ui/buttonClient';
    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          'h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-bg-primary-opacity'
        ),
        day_range_end: 'day-range-end',
        day_selected:
          'bg-bg-primary text-slate-50 hover:bg-bg-primary-opacity hover:text-slate-50 focus:bg-bg-primary focus:text-slate-50 dark:bg-dark-text-primary dark:text-slate-900 dark:hover:bg-dark-text-primary dark:hover:text-slate-900 dark:focus:bg-dark-text-primary dark:focus:text-slate-900',
        day_today:
          'bg-bg-primary-opacity text-slate-900 dark:bg-slate-800 dark:text-slate-50',
        day_outside:
